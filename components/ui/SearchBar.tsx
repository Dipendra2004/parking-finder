...
export function SearchBar({ onSearch, value, onFilterClick }: SearchBarProps) {
  ...
  return (
    <div className="relative flex items-center justify-center">
      <div className="relative flex items-center justify-center group" id="poda">
        ...
        <div className="relative group">
          ...
          <div
            ...
            className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full overflow-hidden rounded-lg bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] border border-transparent cursor-pointer"
          >
